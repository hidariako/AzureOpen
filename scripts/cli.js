...
const contractABI = require("../artifacts/contracts/Azureopenai.sol/Azureopenai.json").abi;

program
    .name("azureopenai-cli")
    .description("CLI tool for Azureopenai smart contract")
    .version("1.0.0");
